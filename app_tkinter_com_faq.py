...
def abrir_faq():
    subprocess.Popen(["python", "faq_tkinter.py"])
...
# Botão para abrir FAQ
btn_faq = tk.Button(root, text="Abrir FAQ", command=abrir_faq, bg="#4CAF50", fg="white", font=("Arial", 12))
btn_faq.pack(pady=10)
